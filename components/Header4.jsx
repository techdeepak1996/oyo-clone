  ...
  return (
    <div className="flex justify-between items-center my-14 border-2 rounded-lg border-gray-300 px-5">
      ...
      <div className="flex">
        <input
          type="email"
          className="px-6 py-3 rounded-lg w-80 h-12 mr-5 outline-none border border-gray-300"
          placeholder="e.g. john@gmail.com"
        />
        <button
          type="submit"
          className="w-40 rounded-lg h-12 bg-red-500 text-xl text-white cursor-pointer"
        >
          Notify
        </button>
      </div>
